...
begin
  ...
  if FHue > 239 then FHue := 239;
  if FLightness < 0 then FLightness := 0;
  if FLightness > 240 then FLightness := 240;
  if FSaturation < 0 then FSaturation := 0;
  if FSaturation > 240 then FSaturation := 240;
end;
//------------------------------------------------------------------------------
